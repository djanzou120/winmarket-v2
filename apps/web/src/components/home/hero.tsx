      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/products"
              className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-200 flex items-center justify-center"
              aria-describedby="shop-description"
            >
              Start Shopping
              <ArrowRight className="ml-2 w-5 h-5" aria-hidden="true" />
            </Link>
            <span id="shop-description" className="sr-only">
              Browse and purchase products from our marketplace
            </span>

            <Link
              href="/auth/register?role=seller"
              className="bg-white text-blue-600 border-2 border-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 focus:outline-none focus:ring-4 focus:ring-blue-300 transition-all duration-200 flex items-center justify-center"
              aria-describedby="seller-description"
            >
              Become a Seller
            </Link>
            <span id="seller-description" className="sr-only">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div
                className="bg-white rounded-full p-4 w-16 h-16 mx-auto mb-4 shadow-md"
                role="img"
                aria-label="Secure wallet icon"
              >
                <Wallet className="w-8 h-8 text-blue-600" aria-hidden="true" />
              </div>
            ...
            <div className="text-center">
              <div
                className="bg-white rounded-full p-4 w-16 h-16 mx-auto mb-4 shadow-md"
                role="img"
                aria-label="Flexible delivery icon"
              >
            ...
            <div className="text-center">
              <div
                className="bg-white rounded-full p-4 w-16 h-16 mx-auto mb-4 shadow-md"
                role="img"
                aria-label="Multi-model marketplace icon"
              >
