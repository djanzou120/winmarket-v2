        ...
        <div className="relative flex flex-col justify-center h-full px-12">
          <div className="max-w-md">
            ...
            <p className="text-blue-100 text-lg mb-8">
              Join our marketplace where buyers and sellers come together. Discover amazing products or start selling your own.
            </p>
            <div className="space-y-4">
              <div className="flex items-center text-blue-100">
                ...
                <span>Secure transactions with wallet system</span>
              </div>
              <div className="flex items-center text-blue-100">
                <div className="w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center mr-3">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center text-blue-100">
                ...
                <span>Comprehensive review system</span>
              </div>
              <div className="flex items-center text-blue-100">
                <div className="w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center mr-3">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
